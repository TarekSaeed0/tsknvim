...
return {
	...
	},
	{
		...
		---@diagnostic disable-next-line: missing-fields
		opts = { ensure_installed = { "javadbg", "javatest" } },
	},
	{
		...
		opts = function()
			...
			if require("tsknvim.utils").is_installed("mason.nvim") then
		...
		config = function(_, opts)
			...
			if require("tsknvim.utils").is_installed("mason.nvim") then
				...
				if
					opts.dap
					and require("tsknvim.utils").is_installed("nvim-dap")
			...
			local function attach_jdtls()
				...
				local config = extend_or_override({
					...
					capabilities = require("tsknvim.utils").is_installed("cmp-nvim-lsp")
